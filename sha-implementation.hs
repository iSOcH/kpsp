-- from http://r6.ca/blog/20060709T153100Z.html
...
shaStep h m = (foldr (flip (.)) id (zipWith mkStep3 ks ws) h) `plus` h
 where
...
prop_sha512B = sha512Ascii ("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn"++
...
prop_sha512C = sha512Ascii (replicate 1000000 'a') ==
